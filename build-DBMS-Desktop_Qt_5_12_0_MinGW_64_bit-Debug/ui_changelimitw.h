...
public:
    ...
    void setupUi(QDialog *changeLimitW)
    {
        ...
        layoutWidget = new QWidget(changeLimitW);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(40, 80, 411, 71));
        ...
        layoutWidget1 = new QWidget(changeLimitW);
        layoutWidget1->setObjectName(QString::fromUtf8("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(40, 280, 571, 81));
        ...
        comboBoxW = new QComboBox(layoutWidget1);
        comboBoxW->addItem(QString());
        comboBoxW->addItem(QString());
        comboBoxW->setObjectName(QString::fromUtf8("comboBoxW"));

        gridLayout->addWidget(comboBoxW, 1, 0, 1, 1);

        comboBoxR = new QComboBox(layoutWidget1);
        ...
        comboBoxC = new QComboBox(layoutWidget1);
        ...
        comboBoxIn = new QComboBox(layoutWidget1);
        ...
        comboBoxdel = new QComboBox(layoutWidget1);
        ...
        comboBoxup = new QComboBox(layoutWidget1);
        ...
        comboBoxS = new QComboBox(layoutWidget1);
    ...
    void retranslateUi(QDialog *changeLimitW)
    {
        ...
        comboBoxW->setItemText(0, QApplication::translate("changeLimitW", "1", nullptr));
        comboBoxW->setItemText(1, QApplication::translate("changeLimitW", "0", nullptr));
